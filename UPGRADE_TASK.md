...
- We should update our unit tests to take into account the new values, and verify our filters.
- We should update our README to take into account the new feature.
